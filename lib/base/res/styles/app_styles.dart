...
class AppStyles {
  ...
  static Color ticketBlue = const Color(0xFF3B4763);
  static Color ticketRed = const Color(0xFFFA5765);
  ...
  static TextStyle headLineStyle2 =
      TextStyle(fontSize: 17, fontWeight: FontWeight.w500, color: Colors.grey.shade500);
